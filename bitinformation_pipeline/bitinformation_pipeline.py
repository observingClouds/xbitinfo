...
parser.add_argument(
    "filename",
    help="filename of dataset (netCDF-file) whose information content should"
    " be retrieved",
    type=str,
)
...
if __name__ == "__main__":
    info_per_bit = get_bitinformation(
        "EUREC4A_DOM01_radiation_20200122T180000Z_latlon.nc"
    )
    print(info_per_bit)
