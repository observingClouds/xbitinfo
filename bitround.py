    ...
    if isinstance(ds, xr.Dataset):
        for v in ds.data_vars:
            if v in keepbits.keys():
                # fails for .data
                if ds[v].dtype == 'float64': # fails otherwise see https://github.com/zarr-developers/numcodecs/blob/7c7dc7cc83db1ae5c9fd93ece863acedbbc8156f/numcodecs/bitround.py#L23
